...
public class bottleScript : MonoBehaviour
{
    ...
    private Vector3 OGbottlePosition;
    private Vector3 snapZonePosition;
    private bool isCorrectSlotBottle = false;
    ...
    private void Start()
    {
        ...
        OGbottlePosition=transform.position;
    }
    ...
    {
        if (isCorrectSlotBottle == false)
        {
            transform.position = OGbottlePosition;
